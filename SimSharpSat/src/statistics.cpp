...
void DataAndStatistics::printShort(const bool pmc) {
  ...
  cout << "c simulation calls \t " << num_simulation_ << endl;
  cout << "c average pi \t " << sum_pi / float(num_simulation_) << endl;
  cout << "c average size \t " << sum_clause / float(num_simulation_) << endl;
